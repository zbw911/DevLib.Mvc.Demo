...
namespace CompositionRoot.Web
{
    public class Registers : RegisterContextBase, IRegister
    {
        ...
        private const string DefaultConnection = "XXDBContext";
        ...
        public override void Register()
        {
            ...
            CommonConfig.Instance()
                .ConfigureData<XX.Data.Models.XXDBContext>(DefaultConnection);
   ...
   .Where(x => !string.IsNullOrEmpty(x.Namespace) && x.Namespace.StartsWith("XX.Services")).ToList();
